...
void Transition::Initialize()
{
	...
	pSprite_[TID_NONE]->Load("Assets/Image/BlackOut.png");
	pSprite_[TID_BLACKOUT]->Load("Assets/Image/BlackOut.png");
	pSprite_[TID_WHITEOUT]->Load("Assets/Image/WhiteOut.png");
}
